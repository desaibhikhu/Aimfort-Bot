...
# Bot information
SESSION = environ.get('SESSION', 'TehVJBot')
...
PICS = (environ.get('PICS', 'https://telegra.ph/file/8087b42dda5b640fb27e9.jpg')).split() #SAMPLE PIC
...
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '1249672673').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://SourabhProfessor:SourabhProfessor@cluster0.a0bz4ht.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
# Links
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/+DNAqhKkpTf0zYTI1')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/vj_bots')
TUTORIAL = environ.get('TUTORIAL', 'https://t.me/How_To_Open_Linkl')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/TG_viewsboster_service') # Support Chat Link Without https:// or @
